...
global.chrome = {
    ...
    storage: {
        session: {
            set: async (obj) => console.log('Mock: chrome.storage.session.set', obj),
            get: async (keys) => ({}),
            remove: async (keys) => console.log('Mock: chrome.storage.session.remove')
        },
        local: {
            set: async (obj) => console.log('Mock: chrome.storage.local.set', obj),
            get: async (keys) => ({}),
            remove: async (keys) => console.log('Mock: chrome.storage.local.remove')
        }
    },
    tabs: {
    ...
    scripting: {
        executeScript: async (options) => console.log('Mock: chrome.scripting.executeScript')
    },
    offscreen: {
        createDocument: async (options) => console.log('Mock: chrome.offscreen.createDocument'),
        closeDocument: async () => console.log('Mock: chrome.offscreen.closeDocument')
    },
    identity: {
        launchWebAuthFlow: async (options) => null
    }
};
